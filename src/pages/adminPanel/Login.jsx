                ...
                <div class="flex flex-col md:flex-row w-4/5 bg-white rounded-xl md:p-20  justify-between items-center">
                    ...
                    <form method="POST" class="md:w-1/2 flex flex-col gap-3 pb-10 md:pb-0" onSubmit={handleSubmit}>
                        ...
                        </h1>
                        {
                            ...
                            <>
                            <div className='w-full bg-red-400 text-center p-3 text-white rounded-lg'>{msg}</div>
                            </>:
                            <>
                            </>
                        }
                        <div>
                            <label for="email" class="block mb-2 text-xs font-medium text-secondary ">
                                Email</label>
                            <input type="email" name="email" id="email"
                                ...
                                placeholder="name@billingcaresolutions.com" required="" />
                        </div>
                        <div>
                            <label for="password" class="block mb-2 text-xs font-medium text-secondary ">Password</label>
                        ...
                        <div class="flex flex-col md:flex-row justify-between gap-3">
                            <button type="submit"
                                class="w-full text-white bg-primary hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-xs px-5 py-2.5 text-center">Sign
                                in</button>
                        </div>
                    </form>
                </div>
