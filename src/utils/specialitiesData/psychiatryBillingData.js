const psychiatryBillingData = {
    ...
    image: "Psychiatry.webp", // Placeholder for the image reference
    short_description:
    ...
    content: {
      ...
      sub_content_2: {
        title: "Transforming Your Practice with Outsourced Psychiatry Billing Solutions",
        image: "",
        details: {
          ...
          data: [
            {
              ...
              detail: "With billing managed by specialists, your team can devote more time to patient interactions and therapeutic outcomes.",
            },
            {
              title: "Faster Payments",
              detail: "Our streamlined claims submission process leads to quicker reimbursements, improving cash flow for your practice.",
            },
            {
              title: "Cost Efficiency",
              detail: "Reducing overhead costs associated with in-house billing while leveraging our specialized knowledge and resources.",
            },
            {
              title: "Minimized Errors",
              detail: "Our in-depth understanding of psychiatry billing significantly reduces coding errors and claim denials, protecting your revenue.",
            },
          ],
        },
      },
          ...
          data: [
            {
              ...
              detail: "Ensuring all services provided are accurately documented and billed.",
            },
            {
              title: "Claims Submission",
              detail: "Optimized processes that expedite claims and enhance approval rates.",
            },
            {
              title: "Proactive Denial Management",
              detail: "Identification and resolution of claim denials, focusing on root causes to prevent future occurrences.",
            },
            {
              title: "Payment Posting",
              detail: "Accurate processing of payments and prompt resolution of discrepancies.",
            },
            {
              title: "Analytics and Reporting",
              detail: "Detailed reporting tools to monitor performance and identify areas for improvement.",
            },
          ],
        },
      },
    ...
    testimonials: [
      {
        ...
        detail: "“Billing Care Solutions has revolutionized our billing process. We’ve seen a significant increase in revenue and can now concentrate on our patients’ mental health.”",
      },
      {
        title: "Dr. Robert T., Child and Adolescent Psychiatrist",
        detail: "“Since we started working with BCS, our claim denials have dropped substantially. Their expertise in psychiatric billing is unmatched.”",
      },
      {
        title: "Dr. Sarah W., Adult Psychiatrist",
        detail: "“The BCS team is highly knowledgeable and responsive. Their support has greatly improved our billing operations.”",
      },
      {
        title: "Dr. Michael R., Psychiatry Practice Director",
        detail: "“With Billing Care Solutions managing our billing, our financial health has improved significantly. We trust them completely with our billing needs.”",
      },
    ],
