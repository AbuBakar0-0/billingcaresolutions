const chiropracticBillingData = {
    ...
    image: "Chiropractic.webp", // Placeholder image reference
    short_description:
          ...
          data: [
            {
              ...
              detail: "Dedicated billing professionals manage the entire claims process, allowing in-house staff to focus on patient care.",
            },
            {
              title: "Faster Payments",
              detail: "Timely and precise claims submission minimizes the time between service delivery and payment, improving cash flow.",
            },
            {
              title: "Enhanced Accuracy",
              detail: "Specialized knowledge in chiropractic coding significantly reduces errors that can lead to claim denials or underpayments.",
            },
            {
              title: "Cost-Effectiveness",
              detail: "By outsourcing, practices can avoid the costs of hiring, training, and maintaining in-house billing staff while minimizing revenue losses.",
            },
          ],
        },
      },
        ...
        details: {
          ...
          data: [
            ...
            },
            {
              ...
              detail: "Each denial is reviewed to identify underlying issues, enabling corrective measures to be implemented.",
            },
            {
              title: "Prevention Strategies",
              detail: "Ongoing training and feedback mechanisms help reduce common denial causes, ensuring smoother operations and improved cash flow.",
            },
          ],
        },
      },
    ...
    testimonials: [
      {
        ...
        detail: "Reduced claim rejection rates and quicker processing times lead to faster reimbursement.",
      },
      {
      ...
      },
      {
        ...
        detail: "Regular updates and immediate responses to inquiries enhance client relationships and trust.",
      },
      {
        title: "Compliance Confidence",
        detail: "Clients appreciate the assurance that their practice remains compliant with current regulations, reducing audit risks.",
      },
    ],
