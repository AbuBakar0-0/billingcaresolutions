const plasticSurgeryBillingData = {
    ...
    image: "Plastic Surgery.webp", // Placeholder for the image reference
    short_description:
    ...
    content: {
      ...
      sub_content_2: {
        title: "Transforming Your Practice with Outsourced Plastic Surgery Billing Solutions",
        image: "",
        details: {
          ...
          data: [
            {
              ...
              detail: "With billing managed by specialists, your team can dedicate more time to patient interactions and surgical outcomes.",
            },
            {
              title: "Faster Payments",
              detail: "Our streamlined claims submission process leads to quicker reimbursements, improving your practice's cash flow.",
            },
            {
              title: "Cost Efficiency",
              detail: "Reducing the overhead associated with in-house billing while accessing specialized knowledge and resources.",
            },
            {
              title: "Minimized Errors",
              detail: "Our deep understanding of plastic surgery billing reduces coding errors and claim denials, safeguarding your revenue.",
            },
          ],
        },
      },
          ...
          data: [
            {
              ...
              detail: "Ensuring all services and procedures are accurately documented and billed.",
            },
            {
    ...
    testimonials: [
      {
        ...
        detail: "“Billing Care Solutions has transformed our billing process. We’ve seen a significant boost in revenue and can focus more on our patients.”",
      },
      {
        title: "Dr. Michael S., Aesthetic Surgeon",
        detail: "“Since partnering with BCS, our claim denials have drastically decreased. Their expertise in plastic surgery billing is invaluable.”",
      },
      {
        title: "Dr. Sara L., Reconstructive Surgeon",
        detail: "“The team at Billing Care Solutions is responsive and professional. Their tailored approach has improved our financial operations significantly.”",
      },
      {
        title: "Dr. John R., Plastic Surgery Clinic Director",
        detail: "“With BCS managing our billing, our cash flow has improved dramatically. We trust them completely with our billing needs.”",
      },
    ],
