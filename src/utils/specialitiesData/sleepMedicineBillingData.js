const sleepMedicineBillingData = {
    ...
    image: "Sleep Medicine.webp", // Placeholder for the image reference
    short_description:
    ...
    content: {
      ...
      sub_content_2: {
        title: "Transforming Your Practice with Outsourced Sleep Medicine Billing Solutions",
        image: "",
        details: {
          ...
          data: [
            {
              ...
              detail: "By leaving the billing complexities to our expert team, your staff can focus fully on providing better care to patients.",
            },
            {
              title: "Improved Revenue",
              detail: "Accurate and timely billing reduces the time between providing sleep medicine services and receiving payment, improving your practice’s cash flow.",
            },
            {
              title: "Cost Efficiency",
              detail: "Outsourcing eliminates the costs of maintaining an in-house billing team, while reducing billing errors that can result in lost revenue.",
            },
          ],
        },
      },
          ...
          data: [
            {
              ...
              detail: "We ensure all procedures, from in-lab sleep studies to home monitoring, are accurately captured and billed.",
            },
            {
              title: "Claims Submission",
              detail: "Timely submission of claims to avoid delays in payment and ensure that all sleep-related services are correctly documented.",
            },
            {
              title: "Denial Management",
              detail: "Identifying and addressing denials quickly, ensuring coding or documentation issues are resolved to prevent future rejections.",
            },
            {
              title: "Payment Posting",
              detail: "We accurately post payments, ensuring full transparency and resolution of any discrepancies.",
            },
            {
              title: "Analytics and Reporting",
              detail: "Our detailed reporting helps you track your practice’s financial performance, enabling proactive decision-making to enhance revenue.",
            },
          ],
        },
      },
    ...
    testimonials: [
      {
        ...
        detail: "“Working with Billing Care Solutions has been a game changer for our sleep clinic. They handle everything from coding to denials, leaving us to focus on our patients.”",
      },
      {
        title: "Dr. James H., Sleep Study Director",
        detail: "“Our revenue increased significantly after outsourcing our billing to BCS. They really understand the complexity of sleep medicine billing and it shows.”",
      },
      {
        title: "Dr. Emily G., Sleep Clinic Owner",
        detail: "“Thanks to BCS, we’ve seen faster claim submissions and payments, with fewer denials. Their expertise is second to none.”",
      },
      {
        title: "Dr. Robert L., Sleep Physician",
        detail: "“The team at Billing Care Solutions provides fantastic support and their attention to detail has improved our cash flow tremendously.”",
      },
    ],
