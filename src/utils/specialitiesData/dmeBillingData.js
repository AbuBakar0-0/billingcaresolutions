const dmeBillingData = {
    ...
    image: "DME.webp", // Placeholder image reference
    short_description:
          ...
          data: [
            {
              ...
              detail: "Dedicated billing professionals manage the entire claims process, freeing up in-house staff to focus on patient support and equipment provision.",
            },
            {
            ...
            },
            {
              ...
              detail: "Specialized knowledge in DME coding and compliance minimizes errors that can lead to claim denials or underpayment.",
            },
            {
              title: "Cost Savings",
              detail: "Outsourcing helps avoid the costs associated with hiring, training, and maintaining in-house billing staff, while reducing revenue leakage from billing errors.",
            },
          ],
        },
      },
          ...
          data: [
            {
              ...
              detail: "Continuous tracking of claims from submission to payment, allowing for quick identification and resolution of denials.",
            },
            {
              title: "Root Cause Analysis",
              detail: "Each denial is thoroughly reviewed to determine underlying issues, enabling corrective measures to be implemented to prevent recurrence.",
            },
            {
              title: "Prevention Strategies",
              detail: "Regular training and feedback mechanisms help reduce common denial causes, ensuring smoother operations and improved cash flow.",
            },
          ],
        },
      },
    ...
    testimonials: [
      {
        ...
        detail: "Quicker processing times and reduced claim rejection rates lead to faster reimbursement and healthier financial outcomes.",
      },
      {
        title: "Increased Revenue",
        detail: "Many clients notice significant revenue growth shortly after outsourcing their billing services.",
      },
      {
        title: "Transparent Communication",
        detail: "We maintain regular updates and prompt responses to inquiries, fostering strong client relationships and trust.",
      },
      {
        title: "Compliance Confidence",
        detail: "Clients appreciate the assurance that their practice remains compliant with the latest regulations, minimizing the risk of audits and penalties.",
      },
    ],
