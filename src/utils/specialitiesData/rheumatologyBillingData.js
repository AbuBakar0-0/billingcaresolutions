const rheumatologyBillingData = {
    ...
    image: "Rheumatology.webp", // Placeholder for the image reference
    short_description:
    ...
    content: {
      ...
      sub_content_2: {
        title: "Transforming Your Practice with Outsourced Rheumatology Billing Solutions",
        image: "",
        details: {
          ...
          data: [
            {
              ...
              detail: "By allowing billing specialists to handle your billing processes, your team can devote more time to patient interactions and treatment.",
            },
            {
              title: "Improved Cash Flow",
              detail: "Our efficient claims submission process leads to faster reimbursements, positively impacting your practice’s financial health.",
            },
            {
              title: "Cost-Effectiveness",
              detail: "Reducing the burden of in-house billing expenses while gaining access to specialized medical billing expertise.",
            },
            {
              title: "Minimized Errors",
              detail: "Our deep understanding of rheumatology billing significantly reduces coding errors and claim denials, optimizing revenue recovery.",
            },
          ],
        },
      },
          ...
          data: [
            {
              ...
              detail: "Ensuring all services related to rheumatology, including diagnostics and therapies, are accurately captured and billed.",
            },
            {
              title: "Claims Submission",
              detail: "Streamlined submission processes designed to expedite claims and enhance approval rates.",
            },
            {
            ...
            },
            {
              ...
              detail: "Comprehensive reporting tools that allow practices to monitor financial performance and identify areas for improvement.",
            },
          ],
        },
      },
    ...
    testimonials: [
      {
        ...
        detail: "“Billing Care Solutions has streamlined our billing process. Our revenue has improved, enabling us to focus on patient care.”",
      },
      {
        title: "Dr. Kevin T., Rheumatology Practice Owner",
        detail: "“Since we partnered with BCS, our claim denials have significantly decreased. Their expertise in rheumatology billing is invaluable.”",
      },
      {
        title: "Dr. Sarah R., Clinical Rheumatologist",
        detail: "“The BCS team is highly knowledgeable and responsive. Their tailored approach has transformed our billing operations.”",
      },
      {
        title: "Dr. Emily S., Rheumatology Practice Director",
        detail: "“With Billing Care Solutions managing our billing, our financial stability has improved tremendously. We trust them completely with our billing needs.”",
      },
    ],
