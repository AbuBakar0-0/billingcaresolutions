const infectiousDiseasesBillingData = {
    ...
    image: "Infectious Diseases.webp", // Placeholder for the image reference
    short_description:
    ...
    content: {
      ...
      sub_content_2: {
        title: "Transforming Your Practice with Outsourced Infectious Diseases Billing Solutions",
        image: "",
        details: {
          ...
          data: [
            {
              ...
              detail: "Delegating the billing process to experts allows your team to prioritize patient care, especially in fast-paced environments where infectious disease management is critical.",
            },
            {
              title: "Increased Revenue",
              detail: "With prompt and accurate claim submission, practices benefit from quicker reimbursements, improving cash flow and reducing financial pressure.",
            },
            {
              title: "Cost Efficiency",
              detail: "Avoid the high costs of hiring and training an in-house billing team, while accessing expert knowledge in infectious disease billing.",
            },
            {
              title: "Error Reduction",
              detail: "Our deep understanding of infectious disease billing results in fewer coding mistakes and claim denials, maximizing revenue potential.",
            },
          ],
        },
      },
          ...
          data: [
            {
              ...
              detail: "Accurately documenting all procedures, tests, and treatments related to infectious diseases and ensuring they are billed accordingly.",
            },
            {
              title: "Claims Submission",
              detail: "Streamlining the claims submission process to minimize turnaround time and ensure faster reimbursements.",
            },
            {
              title: "Denial Management",
              detail: "Proactively addressing claim denials, identifying root causes such as incorrect coding or missing modifiers, and resolving them quickly to prevent future losses.",
            },
            {
              title: "Payment Posting and Reconciliation",
              detail: "Ensuring that payments are posted accurately and that any discrepancies are immediately resolved.",
            },
            {
              title: "Advanced Reporting and Analytics",
              detail: "Offering detailed reporting that enables practices to monitor financial performance, detect trends, and uncover opportunities for improvement.",
            },
          ],
        },
      },
    ...
    testimonials: [
      {
        ...
        detail: "“Billing Care Solutions has been instrumental in improving our revenue cycle. Their team’s knowledge of infectious diseases billing is outstanding.”",
      },
      {
        title: "Dr. Allen P., Infectious Diseases Clinic Owner",
        detail: "“Since partnering with BCS, our claim approval rates have skyrocketed. We no longer have to worry about denials due to coding errors.”",
      },
      {
        title: "Dr. Lisa T., Infectious Diseases Physician",
        detail: "“The team at BCS is proactive and always on top of our billing needs. They’ve made a significant impact on our practice’s financial performance.”",
      },
      {
        title: "Dr. Stephen R., Infectious Diseases Group Director",
        detail: "“Outsourcing to Billing Care Solutions has been one of the best decisions for our practice. They are thorough, efficient, and have helped us recover lost revenue.”",
      },
    ],
