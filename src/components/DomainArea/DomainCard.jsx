        ...
        <>
            <div className="flip-container size-72 relative my-3">
                <div className="flipper absolute size-72 object-fit">
                    {/* <!-- Front of the card --> */}
                    <div className="front flex flex-col justify-center shadow-xl rounded-xl" style={{ backgroundImage: `url("${data.img}")`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                    ...
                    {/* <!-- Back of the card --> */}
                    <div className="back w-72 h-[22rem]  flex flex-col justify-center items-start text-white rounded-xl" style={{ backgroundImage: `url("${data.img}")`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                    </div>
                </div>
            </div>
        </>
