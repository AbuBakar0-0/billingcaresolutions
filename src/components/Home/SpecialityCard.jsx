                ...
                <div className='h-auto m-2'>
                    <div className='flex flex-row justify-around '>
                        ...
                        <div className='flex flex-col justify-start items-start'>
                            <p className='my-2 text-xl text-secondary font-semibold md:min-h-12 lg:min-h-0'>{data.title}</p>
                            <p className='min-h-72 text-md lg:text-lg text-justify hyphens-auto' style={{ wordSpacing: "-0.05em", letterSpacing: "-0.03em" , textJustify:"distribute"}}>
                                {data.description}
                            </p>
                        </div>
                    </div>
            ...
            <div className='flex md:w-[45%] lg:w-[32%] my-4'>
                <div className='w-full'>
                    <div className='flex flex-row justify-around items-center mb-4 gap-4'>
                        ...
                        <div className='flex flex-col justify-start items-start w-full text-lg'>
                            <p className='my-2 text-secondary font-semibold'>{data.title}</p>
                        </div>
                    </div>
                    <p className='text-justify min-h-56 text-md lg:text-lg whitespace-normal break-words tracking-tight'>{data.description}</p>
