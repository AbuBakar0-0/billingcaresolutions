...
const Hero = ({ title, img, short_description }) => {
    return (
        <>
            <div className='bg-secondary text-white' style={{ backgroundImage: `url("${img}")`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' ,backgroundPosition: "center" }}>
                <div className='container mx-auto md:min-h-[28rem] md:max-h-[28rem] flex flex-col md:flex-row justify-start items-center gap-4 text-center lg:p-10'>
                    ...
                    <h1 className='w-full uppercase text-2xl md:text-5xl font-bold'>{title}</h1>
