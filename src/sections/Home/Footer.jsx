          ...
          <div className='w-full md:w-1/3 flex flex-col justify-center items-start space-y-2'>
            ...
            <div className='flex flex-col space-y-2'>
              ...
              <div className='flex flex-row items-center space-x-2'>
                ...
                <p>Email : info@billingcaresolutions.com</p>
              </div>
              <div className='flex flex-row items-center space-x-2'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
              ...
              <div className='flex flex-row items-center'>
                ...
                <p>30n N Gould St, Sheridan, WY 82801, United States</p>
              </div>
              <div className='flex flex-wrap space-x-1 md:space-x-2'>
                <a href="https://www.facebook.com/BillingCareSolutions">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 50 50" className='fill-white'>
                    <path d="M25,3C12.85,3,3,12.85,3,25c0,11.03,8.125,20.137,18.712,21.728V30.831h-5.443v-5.783h5.443v-3.848 c0-6.371,3.104-9.168,8.399-9.168c2.536,0,3.877,0.188,4.512,0.274v5.048h-3.612c-2.248,0-3.033,2.131-3.033,4.533v3.161h6.588 l-0.894,5.783h-5.694v15.944C38.716,45.318,47,36.137,47,25C47,12.85,37.15,3,25,3z"></path>
                  </svg>
                </a>
                <a href="https://www.instagram.com/billingcaresolutions/?hl=en">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 30 30" className='fill-white'>
                ...
                <a href="https://www.threads.net/@billingcaresolutions?hl=en " className='flex justify-center items-center'>
                  <img src="./assets/threads.png" alt="threads @ billingcaresolutions.com" className='w-8 h-8' />
                </a>
