          ...
          <div className='w-full md:w-1/3 flex flex-col justify-center items-start space-y-2'>
            ...
            <div className='flex flex-col space-y-2 gap-3 text-lg'>
              ...
              <div className='flex flex-row items-center space-x-2'>
                <a to="https://www.facebook.com/BillingCareSolutions">
                ...
                <a to="https://www.instagram.com/billingcaresolutions/?hl=en">
                ...
                <a to="https://www.linkedin.com/company/68852117/admin/feed/posts/">
                ...
                <a to="https://www.pinterest.com/Billingcaresolutions/ ">
                ...
                <a to="https://www.threads.net/@billingcaresolutions?hl=en " className='flex justify-center items-center '>
                ...
                <a to="https://www.youtube.com/channel/UCyRZuBQv0paVu9vE674zFpw">
