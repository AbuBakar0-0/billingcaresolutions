...
function Footer() {
  ...
  return (
    <>
      <div className='flex flex-col justify-center items-center bg-secondary text-white font-custom p-10 text-sm space-y-4'>
        <div className='flex flex-col space-y-4 md:space-y-0 md:flex-row justify-between items-start '>
          <div className='w-full md:w-1/3 flex flex-col justify-center items-start space-y-2'>
            <p className='text-2xl text-left uppercase'>Quick Links</p>
            <FooterLine />
          ...
          <div className='w-full md:w-1/3 flex flex-col justify-center items-start space-y-2'>
            <p className='text-2xl text-left uppercase'>Our Services</p>
            <FooterLine />
            <div className='flex flex-col'>
              {services.map((item) => (
                <a href="">{item.title}</a>
          ...
          <div className='w-full md:w-1/3 flex flex-col justify-center items-start space-y-2'>
            <p className='text-2xl text-left uppercase'>Get In Touch</p>
            <FooterLine />
            <div className='flex flex-col space-y-2'>
              ...
              <div className='flex flex-row items-center space-x-2'>
                <a href="https://www.facebook.com/BillingCareSolutions">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0 0 50 50" className='fill-white hover:fill-primary hover:bg-white hover:transition-all hover:duration-300 rounded-full hover:p-1' >
                    <path d="M25,3C12.85,3,3,12.85,3,25c0,11.03,8.125,20.137,18.712,21.728V30.831h-5.443v-5.783h5.443v-3.848 c0-6.371,3.104-9.168,8.399-9.168c2.536,0,3.877,0.188,4.512,0.274v5.048h-3.612c-2.248,0-3.033,2.131-3.033,4.533v3.161h6.588 l-0.894,5.783h-5.694v15.944C38.716,45.318,47,36.137,47,25C47,12.85,37.15,3,25,3z"></path>
                  </svg>
                </a>
                <a href="https://www.instagram.com/billingcaresolutions/?hl=en">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0 0 30 30" className='fill-white hover:fill-primary hover:bg-white hover:transition-all hover:duration-300 rounded-lg hover:p-1'>
                ...
                <a href="https://www.linkedin.com/company/68852117/admin/feed/posts/">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0 0 50 50" className='fill-white hover:fill-primary hover:bg-white hover:transition-all hover:duration-300 rounded-lg hover:p-1'>
