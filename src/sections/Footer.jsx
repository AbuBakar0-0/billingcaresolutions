...
function Footer() {
  ...
  return (
    <>
      <div className='flex flex-col justify-center items-center bg-secondary text-white font-custom p-20 text-sm space-y-4'>
        <div className='flex flex-col space-y-4 md:space-y-0 md:flex-row justify-between items-start'>
          ...
          <div className='w-full md:w-1/3 flex flex-col justify-center items-start space-y-2'>
            ...
            <FooterLine />
            <div className='flex flex-col space-y-2 gap-3 text-lg'>
              <p className='w-full'>
