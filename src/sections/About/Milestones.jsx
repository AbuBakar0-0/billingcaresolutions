    ...
    return (
        <>
            <div className='w-full flex flex-col justify-center items-center gap-3 text-center p-5'>
                ...
                <p className='w-full md:w-1/2 text-center text-md lg:text-lg whitespace-normal break-words tracking-tight'>Our unwavering dedication to excellence in Medical Billing has resulted in exceptional industry recognition and numerous prestigious awards. Some of our notable accomplishments:</p>
            </div>
            <div className='w-full flex flex-col md:flex-row justify-between items-center'>
                <div className='w-full md:w-1/2 flex flex-col justify-center items-center border-l-8 border-secondary p-5 gap-3'>
                    ...
                    <p className='text-justify text-md lg:text-lg whitespace-normal break-words tracking-tight'>We pride ourselves on maintaining exceptional accuracy and operational efficiency in our Medical Billing processes, ensuring timely reimbursements for our clients. Our commitment to meticulous process management and adherence to industry standards has led to a significant reduction in error rates, well below the national benchmark.</p>
                    {acdata.map((item) => (
            ...
            <div className='w-full flex flex-col md:flex-row justify-between items-center'>
                ...
                <div className='w-full md:w-1/2 flex flex-col justify-center items-center border-r-8 border-secondary p-5 gap-3'>
                    ...
                    <p className='text-justify text-md lg:text-lg whitespace-normal break-words tracking-tight'>Our track record of success and commitment to quality has driven substantial growth and diversification in our client base and service portfolio. Our ability to adapt to evolving industry demands and anticipate client needs has positioned us as a leader in the Medical Billing field.</p>
                    {addata.map((item) => (
                        <MilestoneCard data={item} />
                    ))}
                </div>
