        ...
        <>
            <div className='w-full flex flex-col md:flex-row justify-between items-center p-10'>
                <div className='w-full md:w-1/2 flex flex-col justify-start items-center text-left'>
                    <HeadingLine data={"About Billing Care Solutions"} />
                    <p className='w-full text-4xl md:text-6xl text-left font-custom font-semibold'>About the Company</p>
                ...
                <div className='w-full md:w-1/2 flex justify-center items-center'>
                    <img src="./assets/about-us/About-the-Company-billingcaresolutions.com.webp" alt="" className='p-5 h-96'/>
                </div>
            </div>
        </>
    )
