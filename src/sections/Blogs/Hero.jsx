...
function Hero() {
    return (
        <>
            <div className='text-white mb-10' style={{ backgroundImage: `url("./assets/headers/Blogs-billingcaresolutions.com.webp")`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                <div className='container mx-auto min-h-[30rem] flex flex-col md:flex-row justify-start items-center gap-4 text-center p-5'>
                    <div className='w-full md:w-1/2 flex flex-col justify-start items-start text-left gap-4'>
                        ...
                        <h1 className='w-full uppercase text-6xl font-bold'>BCS Blog</h1>
