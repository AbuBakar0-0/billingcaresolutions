        ...
        <nav className="bg-white shadow-md">
            <div className='hidden lg:flex flex-row justify-between items-center'>
                ...
                <div className='w-2/3 flex flex-wrap space-x-1 lg:space-x-2 justify-end  px-10 pt-4'>
                    <a href="https://www.facebook.com/BillingCareSolutions">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0 0 50 50" className='fill-grays'>
                            <path d="M25,3C12.85,3,3,12.85,3,25c0,11.03,8.125,20.137,18.712,21.728V30.831h-5.443v-5.783h5.443v-3.848 c0-6.371,3.104-9.168,8.399-9.168c2.536,0,3.877,0.188,4.512,0.274v5.048h-3.612c-2.248,0-3.033,2.131-3.033,4.533v3.161h6.588 l-0.894,5.783h-5.694v15.944C38.716,45.318,47,36.137,47,25C47,12.85,37.15,3,25,3z"></path>
                        </svg>
                    </a>
                    <a href="https://www.instagram.com/billingcaresolutions/?hl=en">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0 0 30 30" className='fill-grays'>
                    ...
                    <a href="https://www.threads.net/@billingcaresolutions?hl=en " className='flex justify-center items-center'>
                        <img src="./assets/threads-grays.png" alt="threads @ billingcaresolutions.com" className='w- h-7' />
                    </a>
                ...
                <div className="flex justify-between h-16">
                    <div className="w-full flex flex-row justify-between">
                        ...
                        <div className="hidden lg:flex lg:space-x-8 items-center w-3/5 justify-center">
                            <Link to='/' className="text-grays-900 inline-flex items-center px-1 pt-1 text-sm font-medium hover:text-secondary">Home</Link>
                            <Link to='/whybcs' className="text-grays-900 inline-flex items-center px-1 pt-1 text-sm font-medium hover:text-secondary">Why BCS</Link>
                            <Link to='' className="text-grays-900 inline-flex items-center px-1 pt-1 text-sm font-medium hover:text-secondary">Services</Link>
                            <Link to='' className="text-grays-900 inline-flex items-center px-1 pt-1 text-sm font-medium hover:text-secondary">Specialities</Link>
                            <Link to='' className="text-grays-900 inline-flex items-center px-1 pt-1 text-sm font-medium hover:text-secondary">Domain Area</Link>
                            <div className="relative group">
                                <button className="text-grays-900 inline-flex items-center px-1 pt-1 text-sm font-medium hover:text-secondary" onClick={() => toggleSubmenu(0)}>
                                    <p>Resources</p>
            ...
            <div className={`lg:hidden overflow-hidden transition-all duration-300 ease-in-out ${isOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0'}`}>
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    <button className="flex flex-row items-center text-grays-900 px-3 py-2 rounded-md text-base font-medium hover:text-secondary" onClick={() => toggleSubmenu(1)}>
                        <p>Resources</p>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 ml-2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                        </svg>
